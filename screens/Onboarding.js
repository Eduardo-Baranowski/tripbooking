        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={{flex:1, alignItems:"center", justifyContent: 'center'}}>
                <View style={{alignItems: 'center', marginHorizontal: SIZES.padding}}>
                    ...
                    <Text style={{...FONTS.body3, color: COLORS.gray, marginTop: SIZES.padding, textAlign: 'center'}}>Error nulla ut quidem odio fugit veniam. Error nulla ut quidem odio fugit veniam.</Text>
                </View>
