    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{flex:1, justifyContent: 'center'}}>
                    <View style={{flexDirection: 'row', marginTop: SIZES.padding*4, paddingHorizontal: SIZES.base}}>
                        <OptionItem 
                            icon={icons.airplane}
            ...
            <View style={{flex:1}}>
                    <Text style={{marginTop: SIZES.base*8, marginHorizontal: SIZES.padding, ...FONTS.h2}}>Destination</Text>
                    <FlatList 
                        horizontal
